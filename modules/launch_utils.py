...
def prepare_environment():
    ...
    if args.use_ipex:
        if platform.system() == "Windows":
            ...
            # See https://github.com/Nuullll/intel-extension-for-pytorch/releases/tag/v2.1.10%2Bxpu for details.
            #
            # Strengths (over official IPEX 2.1.10 windows release):
            #   - Bundles minimal oneAPI 2023.2 dependencies into the python wheels, so users don't need to install oneAPI for the whole system.
            #   - Provides a compatible torchvision wheel: https://github.com/intel/intel-extension-for-pytorch/issues/465
            # Limitation:
            #   - Only works for python 3.10
            url_prefix = "https://github.com/Nuullll/intel-extension-for-pytorch/releases/download/v2.1.10%2Bxpu"
            torch_command = os.environ.get('TORCH_COMMAND', f"pip install {url_prefix}/torch-2.1.0a0+cxx11.abi-cp310-cp310-win_amd64.whl {url_prefix}/torchvision-0.16.0a0+cxx11.abi-cp310-cp310-win_amd64.whl {url_prefix}/intel_extension_for_pytorch-2.1.10+xpu-cp310-cp310-win_amd64.whl")
        else:
            # Using official IPEX release for linux since it's already an AOT build.
            # However, users still have to install oneAPI toolkit and activate oneAPI environment manually.
            # See https://intel.github.io/intel-extension-for-pytorch/index.html#installation for details.
            torch_index_url = os.environ.get('TORCH_INDEX_URL', "https://pytorch-extension.intel.com/release-whl/stable/xpu/us/")
            torch_command = os.environ.get('TORCH_COMMAND', f"pip install torch==2.1.0.post3 intel-extension-for-pytorch==2.1.40+xpu --extra-index-url {torch_index_url}")
